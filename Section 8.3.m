...
/*[
    ...
    x[1]^2*x[4] + x[1]*x[2]*x[3] + x[1]*x[2]*x[4],
    x[1]*x[2]*x[4] + x[2]^2*x[3] + x[2]^2*x[4],
    -6*x[1]^2*x[3] - 7*x[1]^2*x[4] + 17*x[1]*x[2]*x[3] - 11*x[1]*x[2]*x[4] +
        8*x[2]^2*x[3] + 2*x[2]^2*x[4] - x[3]^3 + 3*x[3]^2*x[4] + 6*x[3]*x[4]^2 +
        x[4]^3,
    -6*x[1]^3 + 18*x[1]^2*x[2] + 36*x[1]*x[2]^2 - x[1]*x[3]^2 + 3*x[1]*x[3]*x[4]
        + x[1]*x[4]^2 + 6*x[2]^3 - x[2]*x[3]^2 - 2*x[2]*x[3]*x[4]
]*/
